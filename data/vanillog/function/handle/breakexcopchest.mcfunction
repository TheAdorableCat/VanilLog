...
scoreboard players remove @s vlBreakExCopChest 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Exposed Copper Chest Broken\"", NoAI: 1b, Silent: 1b}
