...
scoreboard players remove @s vlBreakEmeraldBlock 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName:"\"VanilLog: Emerald Block Broken\"", NoAI:1b, Silent:1b}
