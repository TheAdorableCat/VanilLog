...
scoreboard players remove @s vlBreakWeaCopChest 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Weathered Copper Chest Broken\"", NoAI: 1b, Silent: 1b}
