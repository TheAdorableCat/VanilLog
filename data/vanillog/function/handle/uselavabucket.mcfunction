...
scoreboard players remove @s vlUseLavaBucket 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Lava Bucket Used\"", NoAI: 1b, Silent: 1b}
