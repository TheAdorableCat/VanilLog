...
scoreboard players remove @s vlPickUpPOakCBoat 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Pale Oak Chest Boat Picked Up\"", NoAI: 1b, Silent: 1b}
