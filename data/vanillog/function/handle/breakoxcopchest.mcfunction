...
scoreboard players remove @s vlBreakOxCopChest 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Oxidized Copper Chest Broken\"", NoAI: 1b, Silent: 1b}
