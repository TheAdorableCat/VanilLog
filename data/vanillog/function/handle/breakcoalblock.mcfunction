...
scoreboard players remove @s vlBreakCoalBlock 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Coal Block Broken\"", NoAI: 1b, Silent: 1b}
