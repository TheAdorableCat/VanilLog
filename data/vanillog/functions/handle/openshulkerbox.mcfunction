...
scoreboard players remove @s vlOpShB 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Shulker Box Opened\"", NoAI: 1b, Silent: 1b}
