...
scoreboard players remove @s vlUseWatBuk 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Water Bucket Used\"", NoAI: 1b, Silent: 1b}
