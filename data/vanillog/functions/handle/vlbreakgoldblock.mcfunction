...
summon minecraft:villager ~ ~1000 ~ {CustomName:"\"VanilLog: Gold Block Broken\"", NoAI:1b, Health:1f, Silent:1b, }
...
execute as @e[type=potion,limit=1, tag=vlkill] run data modify entity @s Owner set from entity @p[scores={vlBreakGoldBlock = 1..}] UUID
