...
scoreboard players remove @s vlBrkEmBlk 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName:"\"VanilLog: Emerald Block Broken\"", NoAI:1b, Silent:1b}
