...
#scoreboard players remove @s vlPickUpMangroveCBoat 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Mangrove Chest Boat Picked Up\"", NoAI: 1b, Silent: 1b}
