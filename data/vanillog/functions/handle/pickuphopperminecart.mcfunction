...
scoreboard players remove @s vlPUHoppMC 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Hopper Minecart Picked Up\"", NoAI: 1b, Silent: 1b}
