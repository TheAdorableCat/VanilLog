...
scoreboard players remove @s vlUseLavBuk 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Lava Bucket Used\"", NoAI: 1b, Silent: 1b}
