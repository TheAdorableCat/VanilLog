...
scoreboard players remove @s vlBrkNethBlk 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Netherite Block Broken\"", NoAI: 1b, Silent: 1b}
