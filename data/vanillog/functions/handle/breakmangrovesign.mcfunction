...
#scoreboard players remove @s vlBreakMangrovesign 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Mangrove Sign Broken\"", NoAI: 1b, Silent: 1b}
