...
scoreboard players remove @s vlPUGItmFrm 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Glow Item Frame Picked Up\"", NoAI: 1b, Silent: 1b}
