...
scoreboard players remove @s vlPickUpGlowItemFrame 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Glow Item Frame Picked Up\"", NoAI: 1b, Silent: 1b}
