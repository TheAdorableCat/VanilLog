...
scoreboard players remove @s vlBreakPurpleShulkerBox 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Purple Shulker Box Broken\"", NoAI: 1b, Silent: 1b}
