...
scoreboard players remove @s vlBrkOakSgn 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Oak Sign Broken\"", NoAI: 1b, Silent: 1b}
