...
scoreboard players remove @s vlPlTNTMC 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: TNT Minecart Placed\"", NoAI: 1b, Silent: 1b}
