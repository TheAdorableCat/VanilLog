...
scoreboard players remove @s vlOpenDispenser 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Dispenser Opened\"", NoAI: 1b, Silent: 1b}
