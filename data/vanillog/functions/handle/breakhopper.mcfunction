...
scoreboard players remove @s vlBrkHopp 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Hopper Broken\"", NoAI: 1b, Silent: 1b}
