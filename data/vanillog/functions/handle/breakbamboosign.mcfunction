...
#scoreboard players remove @s vlBreakBamboosign 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Bamboo Sign Broken\"", NoAI: 1b, Silent: 1b}
