...
#scoreboard players remove @s vlPickUpCherryCBoat 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Cherry Chest Boat Picked Up\"", NoAI: 1b, Silent: 1b}
