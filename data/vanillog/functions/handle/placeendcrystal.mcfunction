...
scoreboard players remove @s vlPlaceEndCrystal 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: End Crystal Placed\"", NoAI: 1b, Silent: 1b}
