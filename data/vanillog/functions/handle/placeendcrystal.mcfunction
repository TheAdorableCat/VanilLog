...
scoreboard players remove @s vlPlcECry 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: End Crystal Placed\"", NoAI: 1b, Silent: 1b}
