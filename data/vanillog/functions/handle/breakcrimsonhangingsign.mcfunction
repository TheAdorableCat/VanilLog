...
#scoreboard players remove @s vlBreakCrimsonhangingsign 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Crimson Hanging Sign Broken\"", NoAI: 1b, Silent: 1b}
