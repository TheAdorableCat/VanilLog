...
scoreboard players remove @s vlBreakWarpedsign 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Warped Sign Broken\"", NoAI: 1b, Silent: 1b}
