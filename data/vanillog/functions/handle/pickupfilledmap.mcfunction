...
scoreboard players remove @s vlPUFilMap 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Filled Map Picked Up\"", NoAI: 1b, Silent: 1b}
