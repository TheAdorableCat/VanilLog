...
scoreboard players remove @s vlPickUpFilledMap 1
...
summon minecraft:pig ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Filled Map Picked Up\"", NoAI: 1b, Silent: 1b}
