...
scoreboard players remove @s vlUsFlSt 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Flint And Steel Used\"", NoAI: 1b, Silent: 1b}
