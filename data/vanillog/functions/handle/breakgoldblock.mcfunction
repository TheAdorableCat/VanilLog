...
scoreboard players remove @s vlBrkGldBlk 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName:"\"VanilLog: Gold Block Broken\"", NoAI:1b, Silent:1b}
