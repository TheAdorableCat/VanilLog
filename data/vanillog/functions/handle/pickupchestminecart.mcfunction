...
scoreboard players remove @s vlPUChstMC 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Chest Minecart Picked Up\"", NoAI: 1b, Silent: 1b}
