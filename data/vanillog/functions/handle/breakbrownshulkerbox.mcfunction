...
scoreboard players remove @s vlBrkBrwShB 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Brown Shulker Box Broken\"", NoAI: 1b, Silent: 1b}
