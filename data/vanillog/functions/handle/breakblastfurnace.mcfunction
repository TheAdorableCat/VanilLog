...
scoreboard players remove @s vlBrkBlFurn 1
...
summon minecraft:villager ~ ~1000 ~ { Tags: ["vlPig"], Health:1f, Age:-200, CustomName: "\"VanilLog: Blast Furnace Broken\"", NoAI: 1b, Silent: 1b}
